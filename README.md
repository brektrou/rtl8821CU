# Realtek RTL8811CU/RTL8821CU USB wifi adapter driver version 5.4.1 for Linux 4.4.x up to ...

This fork compiles for kernel 6.1 and tested on open networks. Not all functions/ap settings may work.
